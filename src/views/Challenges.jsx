...
import { Plus, Trash2, Archive, Calendar, DollarSign, Target, AlignLeft, Check, User } from 'lucide-react';
                ...
                {challenges.filter(c => c.isActive).map(c => (
                  <div key={c.id} className="bg-white border border-sage-50 rounded-3xl p-5 shadow-premium">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <h3 className="font-serif text-lg font-bold text-sage-800">{c.title}</h3>
              ...
              <div className="space-y-4 opacity-75">
                {challenges.filter(c => !c.isActive).map(c => (
                  <div key={c.id} className="bg-cream-50 border border-cream-200 rounded-3xl p-5 shadow-sm">
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <h3 className="font-serif text-base font-bold text-cream-600 line-through">{c.title}</h3>
